...
class v35kVGCType:
    ...
    def __init__(self):
        ...
        self.TypeID = 0
        # ===========basic parameters==============
        self.Data35kVGCType = pd.DataFrame()
    ...
    def extraction_data_35kVGCType_resource(self, TypeID):
        self.TypeID = TypeID

        sql = "SELECT * FROM auto_word_electrical_35kvgctype"
        self.Data35kVGCType = connect_sql_pandas(sql)
        self.Data35kVGCType = \
            self.Data35kVGCType.loc[
                self.Data35kVGCType['TypeID'] == self.TypeID]
        return self.Data35kVGCType
    ...
    def generate_dict_35kVGCType_resource(self, data, num):
        ...
        self.RatedBreakingCurrent = self.Data35kVGCType.at[self.Data35kVGCType.index[0], 'RatedBreakingCurrent']
        self.DynamicCurrent = self.Data35kVGCType.at[self.Data35kVGCType.index[0], 'DynamicCurrent']
        self.RatedShortTimeWCurrent = self.Data35kVGCType.at[self.Data35kVGCType.index[0], 'RatedShortTimeWCurrent']

        self.CurrentTransformerRatio = self.Data35kVGCType.at[self.Data35kVGCType.index[0], 'CurrentTransformerRatio']
        self.CurrentTransformerAccuracyClass = self.Data35kVGCType.at[self.Data35kVGCType.index[0], 'CurrentTransformerAccuracyClass']
        ...
        return self.dict_35kVGCType_resource
