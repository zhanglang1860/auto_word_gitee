...
class v35kVMTOCType:
    ...
    def __init__(self):
        ...
        self.TypeID = 0
        # ===========basic parameters==============
        self.Data35kVMTOCType = pd.DataFrame()
    ...
    def extraction_data_35kVMTOCType_resource(self, TypeID):
        self.TypeID = TypeID

        sql = "SELECT * FROM auto_word_electrical_35kvmtovctype"
        self.Data35kVMTOCType = connect_sql_pandas(sql)
        self.Data35kVMTOCType = \
            self.Data35kVMTOCType.loc[
                self.Data35kVMTOCType['TypeID'] == self.TypeID]
        return self.Data35kVMTOCType
    ...
    def generate_dict_35kVMTOCType_resource(self, data, num):
        ...
        self.RatedBreakingCurrent = self.Data35kVMTOCType.at[self.Data35kVMTOCType.index[0], 'RatedBreakingCurrent']
        self.DynamicCurrent = self.Data35kVMTOCType.at[self.Data35kVMTOCType.index[0], 'DynamicCurrent']
        self.RatedShortTimeWCurrent = self.Data35kVMTOCType.at[self.Data35kVMTOCType.index[0], 'RatedShortTimeWCurrent']

        self.CurrentTransformerRatio = self.Data35kVMTOCType.at[self.Data35kVMTOCType.index[0], 'CurrentTransformerRatio']
        self.CurrentTransformerAccuracyClass = self.Data35kVMTOCType.at[self.Data35kVMTOCType.index[0], 'CurrentTransformerAccuracyClass']
        ...
        self.dict_35kVMTOCType_resource = {
            ...
            '额定开断电流_35kV主变出线柜': self.RatedBreakingCurrent,
            '动稳定电流_35kV主变出线柜': self.DynamicCurrent,
            '额定短时耐受电流_35kV主变出线柜': self.RatedShortTimeWCurrent,
            '电流互感器变比_35kV主变出线柜': self.CurrentTransformerRatio,
            '电流互感器准确级_35kV主变出线柜': self.CurrentTransformerAccuracyClass,
            '电流互感器避雷器_35kV主变出线柜': self.CurrentTransformerArrester,
        }


        return self.dict_35kVMTOCType_resource
