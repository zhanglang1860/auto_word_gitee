...
class v35kVSCType:
    ...
    def __init__(self):
        ...
        self.TypeID = 0
        # ===========basic parameters==============
        self.Data35kVSCType = pd.DataFrame()
    ...
    def extraction_data_35kVSCType_resource(self, TypeID):
        self.TypeID = TypeID

        sql = "SELECT * FROM auto_word_electrical_35kvsctype"
        self.Data35kVSCType = connect_sql_pandas(sql)
        self.Data35kVSCType = \
            self.Data35kVSCType.loc[
                self.Data35kVSCType['TypeID'] == self.TypeID]
        return self.Data35kVSCType
    ...
    def generate_dict_35kVSCType_resource(self, data, num):
        self.Data35kVSCType = data
        self.numbers = num
        self.TypeName = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'TypeName']
        self.RatedVoltage = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'RatedVoltage']
        self.RatedCurrent = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'RatedCurrent']
        self.RatedBreakingCurrent = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'RatedBreakingCurrent']
        self.DynamicCurrent = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'DynamicCurrent']
        self.RatedShortTimeWCurrent = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'RatedShortTimeWCurrent']

        self.CurrentTransformerRatio = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'CurrentTransformerRatio']
        self.CurrentTransformerAccuracyClass = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'CurrentTransformerAccuracyClass']
        self.CurrentTransformerArrester = self.Data35kVSCType.at[self.Data35kVSCType.index[0], 'CurrentTransformerArrester']
     
        self.dict_35kVSCType_resource = {
            'numbers_35kV站用变柜': int(self.numbers),
        ...
        return self.dict_35kVSCType_resource
